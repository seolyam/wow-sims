...
**To use the addon**
    ...
    /wse export will open the exporter window, generate WowSims JSON, and have the data ready and highlighted for you to CTRL+C
    /wse rawr will open the exporter window, generate Rawr XML, and have the data ready and highlighted for you to CTRL+C

If you change your gear, and enchants or some gems, you can rerun `/wse export` or `/wse rawr` if you closed the window and the data will be updated, or open the window and click either `Generate WowSims JSON` or `Generate Rawr XML`.

**Rawr import**

1. Generate Rawr XML in the addon (`/wse rawr` or `Generate Rawr XML`).
   The generated XML includes your currently selected talent build and professions.
2. Paste the XML into a file and save it as something like `Character.xml`.
3. Open that file in Rawr using File -> Open.
